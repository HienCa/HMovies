    ...
    return (
        <div className='container mx-auto px-3 my-10'>
            ...
            <div className=''>
                <div
                    ref={containerRef}
                    className='overflow-hidden grid grid-cols-[repeat(auto-fit, 230px)] grid-flow-col gap-6 overflow-x-scroll z-10 relative scroll-smooth transition-all scrollbar-none'
                >
                    {
                        data.map((item, index) => {
                            return (
